...
const YAML_FILE = '/home/nextup/planning_data/points/points.yaml';
const YAML_BACKUP_FILE = 'points_backup.yaml';
const BACKUP_DIR = '/home/nextup/planning_data/points_backup';
...
function formatPointData(joints, coords) {
    const jointsArray = [
        joints.joint1,
        joints.joint2,
        joints.joint3,
...
// Validate point data
function validatePoint(point, isUpdate = false) {
...
app.get('/getPointFileName', async (req, res) => {
    try {
...
app.get('/getPointsBackupFileNames', async (req, res) => {
    try {
...
app.post('/reorderPoints', async (req, res) => {
    try {
