...
class PositionIKRequestWrapper {
  ...
  freeze(own) {
    ...
    if (own) {
      this._wrapperFields.ik_link_name.freeze(own);
    }
    this._refObject.ik_link_name = this._wrapperFields.ik_link_name.refObject;
    this._wrapperFields.pose_stamped.freeze(own);
    ...
    this._wrapperFields.ik_link_names.freeze(own);
    this._refObject.ik_link_names = this._wrapperFields.ik_link_names.refObject;
    if (own) {
      this._wrapperFields.pose_stamped_vector.fill([]);
    }
    this._wrapperFields.pose_stamped_vector.freeze(own);
    this._refObject.pose_stamped_vector = this._wrapperFields.pose_stamped_vector.refObject;
    this._wrapperFields.timeout.freeze(own);
