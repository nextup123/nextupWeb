...
const BoundingVolumeRefStruct = StructType({
...
const BoundingVolumeRefArray = ArrayType(BoundingVolumeRefStruct);
const BoundingVolumeRefStructArray = StructType({
  data: BoundingVolumeRefArray,
  size: ref.types.size_t,
  capacity: ref.types.size_t
});
class BoundingVolumeWrapper {
  constructor(other) {
    this._initialize();
    this._setDefaults();
     if (typeof other === 'object' && other._refObject) {
      this._refObject = new BoundingVolumeRefStruct(other._refObject.toObject());
  ...
  _initialize() {
    this._wrapperFields = {};
    this._refObject = new BoundingVolumeRefStruct();
    this._wrapperFields.primitives = SolidPrimitiveWrapper.createArray();
    this._wrapperFields.primitive_poses = PoseWrapper.createArray();
    this._wrapperFields.meshes = MeshWrapper.createArray();
    this._wrapperFields.mesh_poses = PoseWrapper.createArray();
  ...
  static createFromRefObject(refObject) {
    let self = new BoundingVolumeWrapper();
    self.copyRefObject(refObject);
    return self;
  }
  static createArray() {
    return new BoundingVolumeArrayWrapper();
  }
  static get ArrayType() {
    return BoundingVolumeArrayWrapper;
  }
  static get refObjectArrayType() {
    return BoundingVolumeRefStructArray;
  }
  static get refObjectType() {
    return BoundingVolumeRefStruct;
  }
  toRawROS() {
  ...
  freeze(own) {
    if (own) {
      this._wrapperFields.primitives.fill([]);
    }
    this._wrapperFields.primitives.freeze(own);
    this._refObject.primitives = this._wrapperFields.primitives.refObject;
    if (own) {
      this._wrapperFields.primitive_poses.fill([]);
    }
    this._wrapperFields.primitive_poses.freeze(own);
    this._refObject.primitive_poses = this._wrapperFields.primitive_poses.refObject;
    if (own) {
      this._wrapperFields.meshes.fill([]);
    }
    this._wrapperFields.meshes.freeze(own);
    this._refObject.meshes = this._wrapperFields.meshes.refObject;
    if (own) {
      this._wrapperFields.mesh_poses.fill([]);
    }
    this._wrapperFields.mesh_poses.freeze(own);
  ...
  static destroyRawROS(msg) {
    BoundingVolumeWrapper.freeStruct(msg.refObject);
  }
  static type() {
    return {pkgName: 'moveit_msgs', subFolder: 'msg', interfaceName: 'BoundingVolume'};
  }
  static isPrimitive() {
    return false;
  }
  ...
  copyRefObject(refObject) {
    this._refObject = new BoundingVolumeRefStruct(refObject.toObject());
...
class BoundingVolumeArrayWrapper {
  ...
  fill(values) {
    ...
    values.forEach((value, index) => {
      if (value instanceof BoundingVolumeWrapper) {
        ...
        this._wrappers[index] = new BoundingVolumeWrapper(value);
      }
    });
  }
  freeze(own) {
  ...
  set size(value) {
    if (typeof value != 'number') {
      throw new TypeError('Invalid argument: should provide a number to BoundingVolumeArrayWrapper.size setter');
    }
  ...
  set capacity(value) {
    if (typeof value != 'number') {
      throw new TypeError('Invalid argument: should provide a number to BoundingVolumeArrayWrapper.capacity setter');
    }
    return this._resize(value);
  }
  _resize(size) {
    ...
    this._refArray = new BoundingVolumeRefArray(size);
    this._refObject = new BoundingVolumeRefStructArray();
    this._refObject.size = size;
    this._refObject.capacity = size;
    this._wrappers = new Array();
    for (let i = 0; i < size; i++) {
      this._wrappers.push(new BoundingVolumeWrapper());
    }
  }
  copyRefObject(refObject) {
  ...
  copy(other) {
    if (! (other instanceof BoundingVolumeArrayWrapper)) {
      throw new TypeError('Invalid argument: should provide "BoundingVolumeArrayWrapper".');
    }
  ...
  static freeArray(refObject) {
    ...
    for (let index = 0; index < refObject.size; index++) {
      BoundingVolumeWrapper.freeStruct(refObjectArray[index]);
    }
  }
...
module.exports = BoundingVolumeWrapper;
