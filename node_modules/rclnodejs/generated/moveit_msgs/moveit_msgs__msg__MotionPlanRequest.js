...
class MotionPlanRequestWrapper {
  ...
  freeze(own) {
    this._wrapperFields.workspace_parameters.freeze(own);
    ...
    if (own) {
      this._wrapperFields.goal_constraints.fill([]);
    }
    this._wrapperFields.goal_constraints.freeze(own);
    this._refObject.goal_constraints = this._wrapperFields.goal_constraints.refObject;
    this._wrapperFields.path_constraints.freeze(own);
    this._refObject.path_constraints = this._wrapperFields.path_constraints.refObject;
    this._wrapperFields.trajectory_constraints.freeze(own);
    this._refObject.trajectory_constraints = this._wrapperFields.trajectory_constraints.refObject;
    if (own) {
      this._wrapperFields.reference_trajectories.fill([]);
    }
    this._wrapperFields.reference_trajectories.freeze(own);
    ...
    if (own) {
      this._wrapperFields.planner_id.freeze(own);
    }
    ...
    if (own) {
      this._wrapperFields.cartesian_speed_end_effector_link.freeze(own);
    }
