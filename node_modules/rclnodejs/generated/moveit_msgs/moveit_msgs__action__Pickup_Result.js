...
const Pickup_ResultRefStruct = StructType({
  ...
  grasp: GraspWrapper.refObjectType,
  planning_time: primitiveTypes.float64,
});
const Pickup_ResultRefArray = ArrayType(Pickup_ResultRefStruct);
const Pickup_ResultRefStructArray = StructType({
  data: Pickup_ResultRefArray,
  size: ref.types.size_t,
  capacity: ref.types.size_t
});
class Pickup_ResultWrapper {
  constructor(other) {
    this._initialize();
    this._setDefaults();
     if (typeof other === 'object' && other._refObject) {
      this._refObject = new Pickup_ResultRefStruct(other._refObject.toObject());
      ...
      this._wrapperFields.grasp =  new GraspWrapper(other._wrapperFields.grasp);
  ...
  _initialize() {
    this._wrapperFields = {};
    this._refObject = new Pickup_ResultRefStruct();
    ...
    this._wrapperFields.grasp = new GraspWrapper();
  }
  static createFromRefObject(refObject) {
    let self = new Pickup_ResultWrapper();
    self.copyRefObject(refObject);
    return self;
  }
  static createArray() {
    return new Pickup_ResultArrayWrapper();
  }
  static get ArrayType() {
    return Pickup_ResultArrayWrapper;
  }
  static get refObjectArrayType() {
    return Pickup_ResultRefStructArray;
  }
  static get refObjectType() {
    return Pickup_ResultRefStruct;
  }
  toRawROS() {
  ...
  freeze(own) {
    ...
    if (own) {
      this._wrapperFields.trajectory_stages.fill([]);
    }
    this._wrapperFields.trajectory_stages.freeze(own);
    ...
    this._wrapperFields.trajectory_descriptions.freeze(own);
    this._refObject.trajectory_descriptions = this._wrapperFields.trajectory_descriptions.refObject;
    this._wrapperFields.grasp.freeze(own);
    this._refObject.grasp = this._wrapperFields.grasp.refObject;
  }
  serialize() {
    this.freeze(/*own=*/false);
    return this._refObject.ref();
  ...
  deserialize(refObject) {
    ...
    this._wrapperFields.grasp.copyRefObject(refObject.grasp);
  ...
  static freeStruct(refObject) {
    ...
    GraspWrapper.freeStruct(refObject.grasp);
  }
  static destroyRawROS(msg) {
    Pickup_ResultWrapper.freeStruct(msg.refObject);
  }
  static type() {
    return {pkgName: 'moveit_msgs', subFolder: 'action', interfaceName: 'Pickup_Result'};
  }
  static isPrimitive() {
    return false;
  }
  ...
  get grasp() {
    return this._wrapperFields.grasp;
  }
  set grasp(value) {
    if (value instanceof GraspWrapper) {
      this._wrapperFields.grasp.copy(value);
    } else {
      this._wrapperFields.grasp.copy(new GraspWrapper(value));
    }
  }
  get planning_time() {
  ...
  copyRefObject(refObject) {
    this._refObject = new Pickup_ResultRefStruct(refObject.toObject());
    ...
    this._wrapperFields.grasp.copyRefObject(this._refObject.grasp);
  }
  copy(other) {
    this._refObject = new Pickup_ResultRefStruct(other._refObject.toObject());
...
class Pickup_ResultArrayWrapper {
  ...
  fill(values) {
    ...
    values.forEach((value, index) => {
      if (value instanceof Pickup_ResultWrapper) {
        ...
        this._wrappers[index] = new Pickup_ResultWrapper(value);
      }
    });
  }
  freeze(own) {
  ...
  set size(value) {
    if (typeof value != 'number') {
      throw new TypeError('Invalid argument: should provide a number to Pickup_ResultArrayWrapper.size setter');
    }
  ...
  set capacity(value) {
    if (typeof value != 'number') {
      throw new TypeError('Invalid argument: should provide a number to Pickup_ResultArrayWrapper.capacity setter');
    }
    return this._resize(value);
  }
  _resize(size) {
    ...
    this._refArray = new Pickup_ResultRefArray(size);
    this._refObject = new Pickup_ResultRefStructArray();
    this._refObject.size = size;
    this._refObject.capacity = size;
    this._wrappers = new Array();
    for (let i = 0; i < size; i++) {
      this._wrappers.push(new Pickup_ResultWrapper());
    }
  }
  copyRefObject(refObject) {
  ...
  copy(other) {
    if (! (other instanceof Pickup_ResultArrayWrapper)) {
      throw new TypeError('Invalid argument: should provide "Pickup_ResultArrayWrapper".');
    }
  ...
  static freeArray(refObject) {
    ...
    for (let index = 0; index < refObject.size; index++) {
      Pickup_ResultWrapper.freeStruct(refObjectArray[index]);
    }
  }
...
module.exports = Pickup_ResultWrapper;
