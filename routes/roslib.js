! function() {
        ...
        ! function(a, c) {
            ...
            function d(a) {
                function b(a) {
                    ...
                    if (b !== p.byteLength) {
                        ...
                        for (var e = r + 3 >> 2, f = 0; f < e; ++f) q.setUint32(4 * f, d.getUint32(4 * f))
                    }
                    return o = a, q
                }
                ...
                function i(a) {
                    for (var c = b(a.length), e = 0; e < a.length; ++e) c.setUint8(r + e, a[e]);
                    d()
                }
                ...
                function m(a, b) {
                    b < 24 ? f(a << 5 | b) : b < 256 ? (f(a << 5 | 24), f(b)) : b < 65536 ? (f(a << 5 | 25), j(b)) : b < 4294967296 ? (f(a << 5 | 26), k(b)) : (f(a << 5 | 27), l(b))
                }
                    ...
                    switch (typeof a) {
                        ...
                        case "string":
                            ...
                            for (b = 0; b < a.length; ++b) {
                                ...
                                g < 128 ? d.push(g) : g < 2048 ? (d.push(192 | g >> 6), d.push(128 | 63 & g)) : g < 55296 ? (d.push(224 | g >> 12), d.push(128 | g >> 6 & 63), d.push(128 | 63 & g)) : (g = (1023 & g) << 10, g |= 1023 & a.charCodeAt(++b), g += 65536, d.push(240 | g >> 18), d.push(128 | g >> 12 & 63), d.push(128 | g >> 6 & 63), d.push(128 | 63 & g))
                            }
                ...
                var o, p = new ArrayBuffer(256),
                    q = new DataView(p),
                    r = 0;
                if (n(a), "slice" in p) return p.slice(0, r);
                for (var s = new ArrayBuffer(r), t = new DataView(s), u = 0; u < r; ++u) t.setUint8(u, q.getUint8(u));
                return s
            }
            ...
            function e(a, b, d) {
                ...
                function i() {
                    ...
                    return b.setUint32(0, d << 16 | e << 13 | g << 13), b.getFloat32(0)
                }
                ...
                function r(a) {
                    ...
                    if (255 === b) return -1;
                    var c = q(31 & b);
                    if (c < 0 || b >> 5 !== a) throw "Invalid indefinite length element";
                    return c
                }
                ...
                function s(a, b) {
                    for (var c = 0; c < b; ++c) {
                        var d = l();
                        128 & d && (d < 224 ? (d = (31 & d) << 6 | 63 & l(), b -= 1) : d < 240 ? (d = (15 & d) << 12 | (63 & l()) << 6 | 63 & l(), b -= 2) : (d = (15 & d) << 18 | (63 & l()) << 12 | (63 & l()) << 6 | 63 & l(), b -= 3)), d < 65536 ? a.push(d) : (d -= 65536, a.push(55296 | d >> 10), a.push(56320 | 1023 & d))
                    }
                }
                ...
                function t() {
                    ...
                    if (e = q(m), e < 0 && (g < 2 || 6 < g)) throw "Invalid length";
                    switch (g) {
                        case 0:
                            return e;
                        case 1:
                        ...
                        case 2:
                            if (e < 0) {
                                for (var n = [], o = 0;
                                    (e = r(g)) >= 0;) o += e, n.push(h(e));
                                var u = new Uint8Array(o),
                                    v = 0;
                                for (a = 0; a < n.length; ++a) u.set(n[a], v), v += n[a].length;
                                return u
                            }
                            return h(e);
                        case 3:
                        ...
                        case 4:
                            ...
                            if (e < 0)
                                ...
                                for (x = new Array(e), a = 0; a < e; ++a) x[a] = t();
                            return x;
                        case 5:
                            var y = {};
                            for (a = 0; a < e || e < 0 && !p(); ++a) {
            ...
            "function" == typeof define && define.amd ? define("cbor/cbor", i) : "undefined" != typeof b && b.exports ? b.exports = i : a.CBOR || (a.CBOR = i)
        }(this)
    }, {}],
    2: [function(a, b, c) {
        ! function(a) {
            ...
            function e(b) {
                b ? (this._conf = b, b.delimiter && (this.delimiter = b.delimiter), this._events.maxListeners = b.maxListeners !== a ? b.maxListeners : k, b.wildcard && (this.wildcard = b.wildcard), b.newListener && (this.newListener = b.newListener), b.verboseMemoryLeak && (this.verboseMemoryLeak = b.verboseMemoryLeak), this.wildcard && (this.listenerTree = {})) : this._events.maxListeners = k
            }
            ...
            function f(a, b) {
                ...
                this.verboseMemoryLeak ? (c += " Event name: %s.", console.error(c, a, b)) : console.error(c, a), console.trace && console.trace()
            }

            function g(a) {
                this._events = {}, this.newListener = !1, this.verboseMemoryLeak = !1, e.call(this, a)
            }
            ...
            function h(a, b, c, d) {
                ...
                if (d === n && c._listeners) {
                    ...
                    for (e = 0, f = c._listeners.length; e < f; e++) a && a.push(c._listeners[e]);
                    return [c]
                }
                if ("*" === o || "**" === o || c[o]) {
                    if ("*" === o) {
                        for (g in c) "_listeners" !== g && c.hasOwnProperty(g) && (m = m.concat(h(a, b, c[g], d + 1)));
                        return m
                    }
                    if ("**" === o) {
                        l = d + 1 === n || d + 2 === n && "*" === p, l && c._listeners && (m = m.concat(h(a, b, c, n)));
                        for (g in c) "_listeners" !== g && c.hasOwnProperty(g) && ("*" === g || "**" === g ? (c[g]._listeners && !l && (m = m.concat(h(a, b, c[g], n))), m = m.concat(h(a, b, c[g], d))) : m = g === p ? m.concat(h(a, b, c[g], d + 2)) : m.concat(h(a, b, c[g], d)));
                        return m
                    }
                    m = m.concat(h(a, b, c[o], d + 1))
                }
                if (i = c["*"], i && h(a, b, i, d + 1), j = c["**"])
                    if (d < n) {
                        j._listeners && h(a, b, j, n);
                        for (g in j) "_listeners" !== g && j.hasOwnProperty(g) && (g === p ? h(a, b, j[g], d + 2) : g === o ? h(a, b, j[g], d + 1) : (k = {}, k[g] = j[g], h(a, b, {
                            "**": k
                        }, d + 1)))
                    } else j._listeners ? h(a, b, j, n) : j["*"] && j["*"]._listeners && h(a, b, j["*"], n);
                return m
            }
            ...
            function i(b, c) {
                ...
                for (var g = this.listenerTree, h = b.shift(); h !== a;) {
                    if (g[h] || (g[h] = {}), g = g[h], 0 === b.length) return g._listeners ? ("function" == typeof g._listeners && (g._listeners = [g._listeners]), g._listeners.push(c), !g._listeners.warned && this._events.maxListeners > 0 && g._listeners.length > this._events.maxListeners && (g._listeners.warned = !0, f.call(this, g._listeners.length, h))) : g._listeners = c, !0;
                    h = b.shift()
                }
                return !0
            }
            var j = Array.isArray ? Array.isArray : function(a) {
                ...
                k = 10;
            g.EventEmitter2 = g, g.prototype.delimiter = ".", g.prototype.setMaxListeners = function(b) {
                b !== a && (this._events || d.call(this), this._events.maxListeners = b, this._conf || (this._conf = {}), this._conf.maxListeners = b)
            }, g.prototype.event = "", g.prototype.once = function(a, b) {
                ...
                if (this._all && this._all.length) {
                    if (g = this._all.slice(), i > 3)
                        for (b = new Array(i), f = 0; f < i; f++) b[f] = arguments[f];
                    for (e = 0, c = g.length; e < c; e++) switch (this.event = a, i) {
                        case 1:
                            g[e].call(this, a);
                            break;
                        case 2:
                    ...
                    if (g = this._events[a], "function" == typeof g) {
                        switch (this.event = a, i) {
                            ...
                            case 3:
                                ...
                                break;
                            default:
                                for (b = new Array(i - 1), f = 1; f < i; f++) b[f - 1] = arguments[f];
                                g.apply(this, b)
                        }
                        return !0
                    }
                ...
                if (!this._all && "error" === a) throw arguments[1] instanceof Error ? arguments[1] : new Error("Uncaught, unspecified 'error' event.");
                return !!this._all
            }, g.prototype.emitAsync = function() {
                this._events || d.call(this);
                var a = arguments[0];
                if ("newListener" === a && !this.newListener && !this._events.newListener) return Promise.resolve([!1]);
                var b, c, e, f, g, i = [],
                    j = arguments.length;
                if (this._all) {
                    if (j > 3)
                        for (b = new Array(j), f = 1; f < j; f++) b[f] = arguments[f];
                    for (e = 0, c = this._all.length; e < c; e++) switch (this.event = a, j) {
                        case 1:
                ...
                if ("function" == typeof g) switch (this.event = a, j) {
                    case 1:
                        i.push(g.call(this));
                        break;
                    case 2:
                    ...
                    case 3:
                        ...
                        break;
                    default:
                        for (b = new Array(j - 1), f = 1; f < j; f++) b[f - 1] = arguments[f];
                        i.push(g.apply(this, b))
                } else if (g && g.length) {
                    if (j > 3)
                        for (b = new Array(j - 1), f = 1; f < j; f++) b[f - 1] = arguments[f];
                    for (e = 0, c = g.length; e < c; e++) switch (this.event = a, j) {
                        case 1:
                ...
                } else if (!this._all && "error" === a) return arguments[1] instanceof Error ? Promise.reject(arguments[1]) : Promise.reject("Uncaught, unspecified 'error' event.");
            ...
            }, g.prototype.addListener = g.prototype.on, g.prototype.off = function(b, c) {
                function d(b) {
                    if (b !== a) {
                        var c = Object.keys(b);
                        for (var e in c) {
                            var f = c[e],
                                g = b[f];
                            g instanceof Function || "object" != typeof g || null === g || (Object.keys(g).length > 0 && d(b[f]), 0 === Object.keys(g).length && delete b[f])
                        }
                    }
                }
                ...
                if (this.wildcard) {
                    ...
                    e = this._events[b], f.push({
                        _listeners: e
                    })
                }
                for (var i = 0; i < f.length; i++) {
                    var k = f[i];
                    if (e = k._listeners, j(e)) {
                        for (var l = -1, m = 0, n = e.length; m < n; m++)
                            if (e[m] === c || e[m].listener && e[m].listener === c || e[m]._origin && e[m]._origin === c) {
                                l = m;
                                break
                            } if (l < 0) continue;
                        return this.wildcard ? k._listeners.splice(l, 1) : this._events[b].splice(l, 1), 0 === e.length && (this.wildcard ? delete k._listeners : delete this._events[b]), this.emit("removeListener", b, c), this
                    }(e === c || e.listener && e.listener === c || e._origin && e._origin === c) && (this.wildcard ? delete k._listeners : delete this._events[b], this.emit("removeListener", b, c))
                }
                return d(this.listenerTree), this
            }, g.prototype.offAny = function(a) {
                var b, c = 0,
                    d = 0;
                if (a && this._all && this._all.length > 0) {
                    for (b = this._all, c = 0, d = b.length; c < d; c++)
                        if (a === b[c]) return b.splice(c, 1), this.emit("removeListenerAny", a), this
                } else {
                    for (b = this._all, c = 0, d = b.length; c < d; c++) this.emit("removeListenerAny", b[c]);
                    this._all = []
                }
                return this
            }, g.prototype.removeListener = g.prototype.off, g.prototype.removeAllListeners = function(a) {
                if (0 === arguments.length) return !this._events || d.call(this), this;
                if (this.wildcard)
                ...
                if (this.wildcard) {
                    ...
                    return h.call(this, b, c, this.listenerTree, 0), b
                }
                return this._events || d.call(this), this._events[a] || (this._events[a] = []), j(this._events[a]) || (this._events[a] = [this._events[a]]), this._events[a]
    ...
    4: [function(a, b, c) {
        var d = this.ROSLIB || {
            ...
            e = a("object-assign");
        e(d, a("./core")), e(d, a("./actionlib")), e(d, a("./math")), e(d, a("./tf")), e(d, a("./urdf")), b.exports = d
    }, {
        "./actionlib": 10,
        "./core": 19,
        "./math": 24,
    ...
    6: [function(a, b, c) {
        function d(a) {
            var b = this;
            a = a || {}, this.ros = a.ros, this.serverName = a.serverName, this.actionName = a.actionName, this.timeout = a.timeout, this.omitFeedback = a.omitFeedback, this.omitStatus = a.omitStatus, this.omitResult = a.omitResult, this.goals = {};
            var c = !1;
            ...
            }), this.goalTopic.advertise(), this.cancelTopic.advertise(), this.omitStatus || this.statusListener.subscribe(function(a) {
                c = !0, a.status_list.forEach(function(a) {
                    var c = b.goals[a.goal_id.id];
                    c && c.emit("status", a)
                })
            }), this.omitFeedback || this.feedbackListener.subscribe(function(a) {
                var c = b.goals[a.status.goal_id.id];
                c && (c.emit("status", a.status), c.emit("feedback", a.feedback))
        ...
        d.prototype.__proto__ = g.prototype, d.prototype.cancel = function() {
            var a = new f;
    ...
    7: [function(a, b, c) {
        function d(a) {
            var b = this;
            a = a || {}, this.ros = a.ros, this.serverName = a.serverName, this.actionName = a.actionName, this.timeout = a.timeout, this.omitFeedback = a.omitFeedback, this.omitStatus = a.omitStatus, this.omitResult = a.omitResult;
            var c = new e({
                    ros: this.ros,
                    name: this.serverName + "/goal",
                    messageType: this.actionName + "Goal"
    ...
    8: [function(a, b, c) {
        function d(a) {
            var b = this;
            this.actionClient = a.actionClient, this.goalMessage = a.goalMessage, this.isFinished = !1;
            var c = new Date;
            this.goalID = "goal_" + Math.random() + "_" + c.getTime(), this.goalMessage = new e({
                goal_id: {
                    stamp: {
                        secs: 0,
                        nsecs: 0
        ...
        d.prototype.__proto__ = f.prototype, d.prototype.send = function(a) {
            var b = this;
            b.actionClient.goalTopic.publish(b.goalMessage), a && setTimeout(function() {
    ...
    9: [function(a, b, c) {
        function d(a) {
            var b = this;
            a = a || {}, this.ros = a.ros, this.serverName = a.serverName, this.actionName = a.actionName, this.feedbackPublisher = new e({
                ros: this.ros,
                name: this.serverName + "/feedback",
                messageType: this.actionName + "Feedback"
            ...
            c.advertise(), this.resultPublisher = new e({
                ros: this.ros,
                name: this.serverName + "/result",
                messageType: this.actionName + "Result"
            ...
            this.statusMessage = new f({
                ...
                status_list: []
            }), this.currentGoal = null, this.nextGoal = null, d.subscribe(function(a) {
                b.currentGoal ? (b.nextGoal = a, b.emit("cancel")) : (b.statusMessage.status_list = [{
                    goal_id: a.goal_id,
                    status: 1
                }], b.currentGoal = a, b.emit("goal", a.goal))
            });
            var h = function(a, b) {
                return !(a.secs > b.secs) && (a.secs < b.secs || a.nsecs < b.nsecs)
            };
            g.subscribe(function(a) {
                0 === a.stamp.secs && 0 === a.stamp.secs && "" === a.id ? (b.nextGoal = null, b.currentGoal && b.emit("cancel")) : (b.currentGoal && a.id === b.currentGoal.goal_id.id ? b.emit("cancel") : b.nextGoal && a.id === b.nextGoal.goal_id.id && (b.nextGoal = null), b.nextGoal && h(b.nextGoal.goal_id.stamp, a.stamp) && (b.nextGoal = null), b.currentGoal && h(b.currentGoal.goal_id.stamp, a.stamp) && b.emit("cancel"))
            });
            setInterval(function() {
                var a = new Date,
                    d = Math.floor(a.getTime() / 1e3),
                    e = Math.round(1e9 * (a.getTime() / 1e3 - d));
                b.statusMessage.header.stamp.secs = d, b.statusMessage.header.stamp.nsecs = e, c.publish(b.statusMessage)
            }, 500)
        }
        var e = a("../core/Topic"),
            f = a("../core/Message"),
            g = a("eventemitter2").EventEmitter2;
        d.prototype.__proto__ = g.prototype, d.prototype.setSucceeded = function(a) {
            var b = new f({
                status: {
            ...
            this.resultPublisher.publish(b), this.statusMessage.status_list = [], this.nextGoal ? (this.currentGoal = this.nextGoal, this.nextGoal = null, this.emit("goal", this.currentGoal.goal)) : this.currentGoal = null
            ...
            this.resultPublisher.publish(a), this.nextGoal ? (this.currentGoal = this.nextGoal, this.nextGoal = null, this.emit("goal", this.currentGoal.goal)) : this.currentGoal = null
        }, b.exports = d
    }, {
        "../core/Message": 11,
        "../core/Topic": 18,
    ...
    13: [function(a, b, c) {
        ...
        d.prototype.__proto__ = j.prototype, d.prototype.connect = function(a) {
            if ("socket.io" === this.transportLibrary) this.socket = i(io(a, {
                "force new connection": !0
            }), f(this)), this.socket.on("connect", this.socket.onopen), this.socket.on("data", this.socket.onmessage), this.socket.on("close", this.socket.onclose), this.socket.on("error", this.socket.onerror);
            else if ("RTCPeerConnection" === this.transportLibrary.constructor.name) this.socket = i(this.transportLibrary.createDataChannel(a, this.transportOptions), f(this));
            else if (!this.socket || this.socket.readyState === e.CLOSED) {
                var b = new e(a);
                b.binaryType = "arraybuffer", this.socket = i(b, f(this))
            }
                ...
                c = function(a, d) {
                    for (var e = {}, f = 0; f < a.fieldnames.length; f++) {
                        var g = a.fieldarraylen[f],
                            h = a.fieldnames[f],
                            i = a.fieldtypes[f];
                        if (i.indexOf("/") === -1) g === -1 ? e[h] = i : e[h] = [i];
                        else {
                            for (var j = !1, k = 0; k < d.length; k++)
                                ...
                                var l = c(j, d);
                                g === -1 || (e[h] = [l])
                            } else b.emit("error", "Cannot find " + i + " in decodeTypeDefs")
                        }
                    }
                    return e
                };
    ...
    14: [function(a, b, c) {
        function d(a) {
            a = a || {}, this.ros = a.ros, this.name = a.name, this.serviceType = a.serviceType, this.isAdvertised = !1, this._serviceCallback = null
        }
        var e = a("./ServiceResponse"),
            f = (a("./ServiceRequest"), a("eventemitter2").EventEmitter2);
        d.prototype.__proto__ = f.prototype, d.prototype.callService = function(a, b, c) {
            ...
            this.isAdvertised || "function" != typeof a || (this._serviceCallback = a, this.ros.on(this.name, this._serviceResponse.bind(this)), this.ros.callOnConnection({
    ...
    17: [function(a, b, c) {
        ...
        function d(a) {
            ...
            function d(a, b) {
                if (!h) throw "Cannot process BSON encoded message without BSON header.";
            ...
            return {
                ...
                onmessage: function(a) {
                    if ("undefined" != typeof Blob && a.data instanceof Blob) d(a.data, function(a) {
                        c(a, b)
                    });
        ...
        "../util/cborTypedArrayTags": 40,
        "../util/decompressPng": 43,
        "cbor-js": 1,
        ws: 41
    }],
    18: [function(a, b, c) {
        function d(a) {
            a = a || {}, this.ros = a.ros, this.name = a.name, this.messageType = a.messageType, this.isAdvertised = !1, this.compression = a.compression || "none", this.throttle_rate = a.throttle_rate || 0, this.latch = a.latch || !1, this.queue_size = a.queue_size || 100, this.queue_length = a.queue_length || 0, this.reconnect_on_close = a.reconnect_on_close || !0, this.compression && "png" !== this.compression && "cbor" !== this.compression && "none" !== this.compression && (this.emit("warning", this.compression + " compression is not supported. No compression will be used."), this.compression = "none"), this.throttle_rate < 0 && (this.emit("warning", this.throttle_rate + " is not allowed. Set to 0"), this.throttle_rate = 0);
            var b = this;
            this.reconnect_on_close ? this.callForSubscribeAndAdvertise = function(a) {
                    b.ros.callOnConnection(a), b.waitForReconnect = !1, b.reconnectFunc = function() {
                        b.waitForReconnect || (b.waitForReconnect = !0, b.ros.callOnConnection(a), b.ros.once("connection", function() {
        ...
        var e = a("eventemitter2").EventEmitter2,
            f = a("./Message");
        d.prototype.__proto__ = e.prototype, d.prototype.subscribe = function(a) {
            "function" == typeof a && this.on("message", a), this.subscribeId || (this.ros.on(this.name, this._messageCallback), this.subscribeId = "subscribe:" + this.name + ":" + ++this.ros.idCounter, this.callForSubscribeAndAdvertise({
                op: "subscribe",
                id: this.subscribeId,
            ...
            a && (this.off("message", a), this.listeners("message").length) || this.subscribeId && (this.ros.off(this.name, this._messageCallback), this.reconnect_on_close && this.ros.off("close", this.reconnectFunc), this.emit("unsubscribe"), this.ros.callOnConnection({
                op: "unsubscribe",
                id: this.subscribeId,
                topic: this.name
            }), this.subscribeId = null)
        }, d.prototype.advertise = function() {
            if (!this.isAdvertised && (this.advertiseId = "advertise:" + this.name + ":" + ++this.ros.idCounter, this.callForSubscribeAndAdvertise({
                    op: "advertise",
                    id: this.advertiseId,
                    type: this.messageType,
                    topic: this.name,
    ...
    20: [function(a, b, c) {
        function d(a) {
            a = a || {}, this.position = new e(a.position), this.orientation = new f(a.orientation)
        }
        var e = a("./Vector3"),
            f = a("./Quaternion");
        d.prototype.applyTransform = function(a) {
            this.position.multiplyQuaternion(a.rotation), this.position.add(a.translation);
            ...
            var b = a.clone();
            return b.applyTransform({
                rotation: this.orientation,
                translation: this.position
            }), b
        }, d.prototype.getInverse = function() {
            var a = this.clone();
            return a.orientation.invert(), a.position.multiplyQuaternion(a.orientation), a.position.x *= -1, a.position.y *= -1, a.position.z *= -1, a
        }, b.exports = d
    }, {
        "./Quaternion": 21,
        "./Vector3": 23
    ...
    21: [function(a, b, c) {
        function d(a) {
            a = a || {}, this.x = a.x || 0, this.y = a.y || 0, this.z = a.z || 0, this.w = "number" == typeof a.w ? a.w : 1
        }
        d.prototype.conjugate = function() {
            ...
            0 === a ? (this.x = 0, this.y = 0, this.z = 0, this.w = 1) : (a = 1 / a, this.x = this.x * a, this.y = this.y * a, this.z = this.z * a, this.w = this.w * a)
    ...
    22: [function(a, b, c) {
        function d(a) {
            a = a || {}, this.translation = new e(a.translation), this.rotation = new f(a.rotation)
        }
        var e = a("./Vector3"),
            f = a("./Quaternion");
        d.prototype.clone = function() {
    ...
    23: [function(a, b, c) {
        function d(a) {
            a = a || {}, this.x = a.x || 0, this.y = a.y || 0, this.z = a.z || 0
        }
        d.prototype.add = function(a) {
            ...
            this.x = b * a.w + e * -a.x + c * -a.z - d * -a.y, this.y = c * a.w + e * -a.y + d * -a.x - b * -a.z, this.z = d * a.w + e * -a.z + b * -a.y - c * -a.x
        }, d.prototype.clone = function() {
            return new d(this)
        }, b.exports = d
    }, {}],
    ...
    26: [function(a, b, c) {
        function d(a) {
            a = a || {}, this.ros = a.ros, this.fixedFrame = a.fixedFrame || "/base_link", this.angularThres = a.angularThres || 2, this.transThres = a.transThres || .01, this.rate = a.rate || 10, this.updateDelay = a.updateDelay || 50;
            ...
            this.topicTimeout = {
                secs: c,
                nsecs: d
            }, this.serverName = a.serverName || "/tf2_web_republisher", this.repubServiceName = a.repubServiceName || "/republish_tfs", this.currentGoal = !1, this.currentTopic = !1, this.frameInfos = {}, this.republisherUpdateRequested = !1, this.actionClient = this.ros.ActionClient({
        ...
        var e = (a("../actionlib/ActionClient"), a("../actionlib/Goal")),
            f = (a("../core/Service.js"), a("../core/ServiceRequest.js")),
            g = a("../math/Transform");
        d.prototype.processTFArray = function(a) {
            ...
            if (this.ros.groovyCompatibility) this.currentGoal && this.currentGoal.cancel(), this.currentGoal = new e({
                actionClient: this.actionClient,
                goalMessage: a
            }), this.currentGoal.on("feedback", this.processTFArray.bind(this)), this.currentGoal.send();
            else {
            ...
            this.currentTopic && this.currentTopic.unsubscribe(), this.currentTopic = this.ros.Topic({
                name: a.topic_name,
                messageType: "tf2_web_republisher/TFArray"
            }), this.currentTopic.subscribe(this.processTFArray.bind(this))
        }, d.prototype.subscribe = function(a, b) {
            "/" === a[0] && (a = a.substring(1)), this.frameInfos[a] ? this.frameInfos[a].transform && b(this.frameInfos[a].transform) : (this.frameInfos[a] = {
                cbs: []
            }, this.republisherUpdateRequested || (setTimeout(this.updateGoal.bind(this), this.updateDelay), this.republisherUpdateRequested = !0)), this.frameInfos[a].cbs.push(b)
        }, d.prototype.unsubscribe = function(a, b) {
            "/" === a[0] && (a = a.substring(1));
            for (var c = this.frameInfos[a], d = c && c.cbs || [], e = d.length; e--;) d[e] === b && d.splice(e, 1);
            b && 0 !== d.length || delete this.frameInfos[a]
        }, d.prototype.dispose = function() {
            this.actionClient.dispose(), this.currentTopic && this.currentTopic.unsubscribe()
        }, b.exports = d
    }, {
        "../actionlib/ActionClient": 6,
        "../actionlib/Goal": 8,
        "../core/Service.js": 14,
        "../core/ServiceRequest.js": 15,
        "../math/Transform": 22
    }],
    27: [function(a, b, c) {
        var d = a("../core/Ros"),
    ...
    29: [function(a, b, c) {
        function d(a) {
            ...
            this.r = parseFloat(b[0]), this.g = parseFloat(b[1]), this.b = parseFloat(b[2]), this.a = parseFloat(b[3])
        }
        b.exports = d
    }, {}],
    30: [function(a, b, c) {
        function d(a) {
            this.type = e.URDF_CYLINDER, this.length = parseFloat(a.xml.getAttribute("length")), this.radius = parseFloat(a.xml.getAttribute("radius"))
        }
        var e = a("./UrdfTypes");
        b.exports = d
    }, {
    ...
    31: [function(a, b, c) {
        function d(a) {
            this.name = a.xml.getAttribute("name"), this.type = a.xml.getAttribute("type");
            ...
            d.length > 0 && (this.minval = parseFloat(d[0].getAttribute("lower")), this.maxval = parseFloat(d[0].getAttribute("upper")));
            ...
            if (0 === h.length) this.origin = new e;
                ...
                if (k) {
                    ...
                    var m = parseFloat(k[0]),
                        ...
                        q = n / 2,
                        r = o / 2,
                        s = Math.sin(p) * Math.cos(q) * Math.cos(r) - Math.cos(p) * Math.sin(q) * Math.sin(r),
                        t = Math.cos(p) * Math.sin(q) * Math.cos(r) + Math.sin(p) * Math.cos(q) * Math.sin(r),
                        u = Math.cos(p) * Math.cos(q) * Math.sin(r) - Math.sin(p) * Math.sin(q) * Math.cos(r),
                        v = Math.cos(p) * Math.cos(q) * Math.cos(r) + Math.sin(p) * Math.sin(q) * Math.sin(r);
                    l = new g({
                        x: s,
                        y: t,
                        z: u,
    ...
    32: [function(a, b, c) {
        function d(a) {
            ...
            for (var b = a.xml.getElementsByTagName("visual"), c = 0; c < b.length; c++) this.visuals.push(new e({
                xml: b[c]
            }))
        }
        var e = a("./UrdfVisual");
    ...
    33: [function(a, b, c) {
        function d(a) {
            this.textureFilename = null, this.color = null, this.name = a.xml.getAttribute("name");
    ...
    34: [function(a, b, c) {
        function d(a) {
            this.scale = null, this.type = f.URDF_MESH, this.filename = a.xml.getAttribute("filename");
    ...
    35: [function(a, b, c) {
        function d(a) {
            ...
            var b = a.xml,
                c = a.string;
            if (this.materials = {}, this.links = {}, this.joints = {}, c) {
                var d = new h;
            ...
            for (var j = i.childNodes, k = 0; k < j.length; k++) {
                ...
                if ("material" === l.tagName) {
                    ...
                    if (void 0 !== this.links[n.name]) console.warn("Link " + n.name + " is not unique.");
                    else {
    ...
    36: [function(a, b, c) {
        function d(a) {
            this.type = e.URDF_SPHERE, this.radius = parseFloat(a.xml.getAttribute("radius"))
        }
        var e = a("./UrdfTypes");
        b.exports = d
    }, {
    ...
    40: [function(a, b, c) {
        ...
        function d() {
            j || (j = !0, console.warn("CBOR 64-bit integer array values may lose precision. No further warnings."))
        }

        function e(a) {
            d();
            for (var b = a.byteLength, c = b / 8, e = a.buffer.slice(-b), f = new Uint32Array(e), g = new Array(c), h = 0; h < c; h++) {
                var j = 2 * h,
                    k = f[j],
                    l = f[j + 1];
                g[h] = k + i * l
        ...
        function f(a) {
            d();
            for (var b = a.byteLength, c = b / 8, e = a.buffer.slice(-b), f = new Uint32Array(e), g = new Int32Array(e), h = new Array(c), j = 0; j < c; j++) {
                var k = 2 * j,
                    l = f[k],
                    m = g[k + 1];
                h[j] = l + i * m
    ...
    43: [function(a, b, c) {
        ...
        function d(a, b) {
            ...
            c.onload = function() {
                var a = new e,
                    d = a.getContext("2d");
                a.width = c.width, a.height = c.height, d.imageSmoothingEnabled = !1, d.webkitImageSmoothingEnabled = !1, d.mozImageSmoothingEnabled = !1, d.drawImage(c, 0, 0);
                for (var f = d.getImageData(0, 0, c.width, c.height).data, g = "", h = 0; h < f.length; h += 4) g += String.fromCharCode(f[h], f[h + 1], f[h + 2]);
                b(JSON.parse(g))
    ...
    44: [function(a, b, c) {
        c.DOMImplementation = window.DOMImplementation, c.XMLSerializer = window.XMLSerializer, c.DOMParser = window.DOMParser
    }, {}]
}, {}, [5]); 