...
const XML_FILE = '/home/nextup/user_config_files/planning_data/planning_trees/path_plan_tree.xml';
const XML_BACKUP_FILE = '/home/nextup/user_config_files/planning_data/planning_trees/path_plan_tree_backup.xml';

// const pointsYamlFile = fs.readFileSync('/home/nextup/user_config_files/planning_data/points/points.yaml', 'utf8');
const pointsYamlFilePath = '/home/nextup/user_config_files/planning_data/points/points.yaml';

const pathsYamlFile = '/home/nextup/user_config_files/planning_data/paths/paths.yaml';
...
router.get('/getPointNames', async (req, res) => {
    try {
