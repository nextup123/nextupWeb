...
app.use(express.static("public/pathTesting")); // Serve static files

app.get("/sequence-creator", (req, res) => {
    res.sendFile(path.join(__dirname, "public", 'test', "sequence-creator.html"));
});

// app.get("/testPath", (req, res) => {
//     res.sendFile(path.join(__dirname, "public", 'test', "testPath.html"));
// });

app.get("/sequence-runner", (req, res) => {
    res.sendFile(path.join(__dirname, "public", "test", "sequence_runner.html"));
});
