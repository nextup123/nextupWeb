...
class SteeringControllerStatusWrapper {
  ...
  freeze(own) {
    ...
    this._wrapperFields.traction_wheels_position.freeze(own);
    ...
    this._wrapperFields.traction_wheels_velocity.freeze(own);
    ...
    this._wrapperFields.steer_positions.freeze(own);
    ...
    this._wrapperFields.linear_velocity_command.freeze(own);
    ...
    this._wrapperFields.steering_angle_command.freeze(own);
