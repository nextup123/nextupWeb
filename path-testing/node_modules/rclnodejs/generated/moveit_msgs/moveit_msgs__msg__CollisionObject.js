...
class CollisionObjectWrapper {
  ...
  freeze(own) {
    ...
    if (own) {
      this._wrapperFields.planes.fill([]);
    }
    this._wrapperFields.planes.freeze(own);
    this._refObject.planes = this._wrapperFields.planes.refObject;
    if (own) {
      this._wrapperFields.plane_poses.fill([]);
    }
    this._wrapperFields.plane_poses.freeze(own);
    ...
    this._wrapperFields.subframe_names.freeze(own);
    this._refObject.subframe_names = this._wrapperFields.subframe_names.refObject;
    if (own) {
      this._wrapperFields.subframe_poses.fill([]);
    }
    this._wrapperFields.subframe_poses.freeze(own);
