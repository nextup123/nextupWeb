...
class PlanningSceneWrapper {
  ...
  freeze(own) {
    ...
    if (own) {
      this._wrapperFields.robot_model_name.freeze(own);
    }
    this._refObject.robot_model_name = this._wrapperFields.robot_model_name.refObject;
    if (own) {
      this._wrapperFields.fixed_frame_transforms.fill([]);
    }
    this._wrapperFields.fixed_frame_transforms.freeze(own);
    this._refObject.fixed_frame_transforms = this._wrapperFields.fixed_frame_transforms.refObject;
    this._wrapperFields.allowed_collision_matrix.freeze(own);
    this._refObject.allowed_collision_matrix = this._wrapperFields.allowed_collision_matrix.refObject;
    if (own) {
      this._wrapperFields.link_padding.fill([]);
    }
    this._wrapperFields.link_padding.freeze(own);
    this._refObject.link_padding = this._wrapperFields.link_padding.refObject;
    if (own) {
      this._wrapperFields.link_scale.fill([]);
    }
    this._wrapperFields.link_scale.freeze(own);
    this._refObject.link_scale = this._wrapperFields.link_scale.refObject;
    if (own) {
      this._wrapperFields.object_colors.fill([]);
    }
    this._wrapperFields.object_colors.freeze(own);
    this._refObject.object_colors = this._wrapperFields.object_colors.refObject;
    this._wrapperFields.world.freeze(own);
