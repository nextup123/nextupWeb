...
class ControllerStateWrapper {
  ...
  freeze(own) {
    ...
    this._wrapperFields.claimed_interfaces.freeze(own);
    ...
    this._wrapperFields.required_command_interfaces.freeze(own);
    ...
    this._wrapperFields.required_state_interfaces.freeze(own);
    ...
    this._wrapperFields.reference_interfaces.freeze(own);
    this._refObject.reference_interfaces = this._wrapperFields.reference_interfaces.refObject;
    if (own) {
      this._wrapperFields.chain_connections.fill([]);
    }
    this._wrapperFields.chain_connections.freeze(own);
