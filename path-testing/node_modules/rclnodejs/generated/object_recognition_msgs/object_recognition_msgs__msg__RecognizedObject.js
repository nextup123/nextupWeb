...
class RecognizedObjectWrapper {
  ...
  freeze(own) {
    ...
    if (own) {
      this._wrapperFields.point_clouds.fill([]);
    }
    this._wrapperFields.point_clouds.freeze(own);
    this._refObject.point_clouds = this._wrapperFields.point_clouds.refObject;
    this._wrapperFields.bounding_mesh.freeze(own);
    this._refObject.bounding_mesh = this._wrapperFields.bounding_mesh.refObject;
    if (own) {
      this._wrapperFields.bounding_contours.fill([]);
    }
    this._wrapperFields.bounding_contours.freeze(own);
